...
const produtoUm = new Produto('Celular', 890);
produtoUm.desconto = 0.05;
console.log(produtoUm.resumo());
const produtoDois = new Produto('Notebook', 1200, 0.5);
console.log(produtoDois.resumo());
